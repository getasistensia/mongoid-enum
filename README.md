...
[![Build
Status](https://travis-ci.org/op-works/mongoid-enum.png)](https://travis-ci.org/op-works/mongoid-enum)
[![Code Climate](https://codeclimate.com/github/op-works/mongoid-enum.png)](https://codeclimate.com/github/op-works/mongoid-enum)
...
issue](https://github.com/op-works/mongoid-enum/issues) (and a failing
